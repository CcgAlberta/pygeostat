...
def check_pyd(pyd='pygsb'):
    ...
    Only pygsb.pyd is available.
    
    Parameters:
        pyd (str): Name of .pyd file required (default).
          
    .. codeauthor:: Harold Velasquez 2021-11-09.
    '''
    import os
    import subprocess
    
    cwd = os.path.abspath(os.path.join(os.path.dirname(__file__), '../fortran'))
    comp = 'python compile.py -compiler=gnu ' + pyd
    
    if not os.path.isfile(os.path.join(cwd, pyd + '.pyd')):
