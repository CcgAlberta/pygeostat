...
# public
#
# pygeostat documentation build configuration file, created by
...
# ones.
# NOTE: plot_directive requires Sphinx 1.6.7 https://github.com/rtfd/readthedocs.org/issues/4057
extensions = [
...
latex_documents = [
    (master_doc, 'pygeostat.tex', 'pygeostat Documentation',
     'Center for Computational Geostatistics', 'manual'),
]
...
man_pages = [
    (master_doc, 'pygeostat', 'pygeostat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pygeostat', 'pygeostat Documentation',
     author, 'pygeostat', 'One line description of project.',
     'Miscellaneous'),
]
